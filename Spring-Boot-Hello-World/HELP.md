...
* The original package name 'com.codacum.Spring-Boot-Hello-World' is invalid and this project uses 'com.codacum.SpringBootHelloWorld' instead.
...
```
$ docker run --rm -p 8080:8080 Spring-Boot-Hello-World:0.0.1-SNAPSHOT
```
...
```
$ target/Spring-Boot-Hello-World
```
